                    ...
                    <div class="card-pricing2 card-success">
                        ...
                        <form>
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <a onclick="tambahBarang()" id="tambahBarang" class="btn btn-info btn-border w-100 fw-bold mb-3">Tambah</a>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" class="form-control input-pill" id="harga_beli" placeholder="Rp">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
    ...
    function tampilData() {
        ...
        for (var i = 0; i < barang.length; i++) {
            if ($('#idBarang').val() == barang[i].id) {
                ...
                $('#harga_beli').val(barang[i].harga_beli);
                barangKosong = false;
                break;
            }
        }
