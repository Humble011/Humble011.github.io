...
<head>
    ...
    <title>SI-Toktong <?= $url->getSegment(3) ?></title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-3">SI-Toktong</div>
            </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Topbar -->
                <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color: rgb(106, 212, 221)">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link" href="#" onclick="confirmLogout()" role="button" aria-haspopup="true" aria-expanded="false">
                                <i class="fas fa-sign-out-alt fa-fw"></i>
                                <span class="mr-2 d-none d-lg-inline text-white-600 small"> Log out</span>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#">
                                <span class="mr-2 d-none d-lg-inline text-white-600 small"><?= session()->get("nama") ?></span>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; SI-Toktong 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
